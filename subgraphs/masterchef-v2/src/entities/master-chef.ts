...
export function getOrCreateMasterChef(block: ethereum.Block): MasterChef {
  ...
  if (masterChef === null) {
    ...
    // masterChef.squadRateToBurn = BigInt.fromString("750000000000");
    masterChef.squadRateToRegularFarm = BigInt.fromString("100000000000");
    masterChef.squadRateToSpecialFarm = BigInt.fromString("150000000000");
