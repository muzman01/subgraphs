...
export function handleNewUpkeepPeriod(event: NewUpkeepPeriod): void {
  ...
  //   event.params.squadAmount.toString(),
  //   event.params.squadPerSecond.toString(),
  ...
  masterChef.latestPeriodSquadPerSecond = event.params.squadPerSecond;
  masterChef.latestPeriodSquadAmount = event.params.squadAmount;
}
...
//     event.params.remainedSquad.toString(),
//   ]);
